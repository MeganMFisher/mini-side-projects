...
function accountingOffice(num1){
...
function frodo(startingHungerValue, startingDangerValue) {
  ...
  return {
    dinnerOverFire: function(){
      this.hungry = this.hungry - 25 ? this.hungry - 25 : 0;
      this.danger = this.danger + 40 ? this.danger + 40 : 100;
    },
    hidinginBush: function(){
      this.hunger = this.hungry + 35 ? this.hungry + 35 : 100;
      this.danger = this.danger - 20 ? this.danger -20 : 0;
    }
  }
}